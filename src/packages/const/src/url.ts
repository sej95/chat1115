...
export const OFFICIAL_URL = 'https://iuaihub.com';
export const OFFICIAL_PREVIEW_URL = 'https://chat-preview.iuaihub.com';
export const OFFICIAL_SITE = 'https://iuaihub.github.io/';

export const OG_URL = '/og/cover.png?v=1';

export const GITHUB = 'https://github.com/iuaihub/iuai-chat';
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://iuaihub.com/changelog';
...
export const FEEDBACK = 'https://github.com/iuaihub/iuai-chat/issues/new/choose';
...
export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/iuaihub/iuai-chat/discussions/6157';
...
export const BASE_PROVIDER_DOC_URL = 'https://iuaihub.com/docs/usage/providers';
